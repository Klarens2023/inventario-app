...
export default function AcumuladosPage() {
  ...
  return (
    <div style={{ padding: '24px 32px', height: '100%', minHeight: 0, display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {/* Matriz pivot */}
      <div style={{ flex: 1, minHeight: 0, overflow: 'auto', background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 8 }}>
        {loading ? (
