...
export async function logAudit(params: {
  ...
  accion: 'CARGA_INVENTARIO' | 'CONTEO_ACTUALIZADO' | 'CONTEO_ACUMULADO' | 'HISTORIAL_REINICIADO' | 'USUARIO_CREADO' | 'USUARIO_MODIFICADO' | 'EQUIPO_CREADO' | 'EQUIPO_ACTUALIZADO' | 'EQUIPO_ELIMINADO' | 'PVN_REGISTRO_CREADO'
  descripcion: string
